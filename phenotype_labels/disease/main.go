...
func main() {
	...
	flag.StringVar(&BQ.Database, "database", "", "BigQuery source database name (note: must be formatted as project.database, e.g., broad-ml4h.ukbb7089_201904)")
	flag.StringVar(&tabfile, "tabfile", "", "Tabfile-formatted phenotype definition")
	flag.StringVar(&materializedDB, "materialized", "broad-ml4h.ukbb7089_201904", "project.database storing materialized view tables")
