...
def parse_args():
    ...
    parser.add_argument('--learning_rate_schedule', default=None, type=str, choices=['triangular', 'triangular2', 'CosineDecay'], help='Adjusts learning rate during training.')
    ...
    parser.add_argument('--writepngs', default=False, action='store_true', help='Write pngs of slices.')
    ...
    parser.add_argument('--plot_hist', default=True, h_elp='Plot histograms of continuous tensors in explore mode.')
