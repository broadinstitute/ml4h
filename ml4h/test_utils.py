...
TMAPS_2D_TO_4D = CONTINUOUS_TMAPS[1:-1] + CATEGORICAL_TMAPS[1:-1]
...
def build_hdf5s(path: str, tensor_maps: List[TensorMap], n=50, keys_are_paths: bool = True) -> Dict[Tuple[str, TensorMap], np.ndarray]:
    """
