...
t1_dicom_16_slices_144_160 = TensorMap(
    ...
    normalization=ZeroMeanStd1(),
    tensor_from_file=_slice_subset_tensor(
        't1_p2_1mm_fov256_sag_ti_880_1', 144, 160, 1, pad_shape=(192, 256, 208),
    ),
)
t1_dicom_16_slices_128_144 = TensorMap(
    't1_dicom_16_slices_128_144',
    shape=(192, 256, 16),
    path_prefix='ukb_brain_mri',
    normalization=ZeroMeanStd1(),
    tensor_from_file=_slice_subset_tensor(
        't1_p2_1mm_fov256_sag_ti_880_1', 128, 144, 1, pad_shape=(192, 256, 208),
    ),
)
t1_dicom_16_slices_96_112 = TensorMap(
    't1_dicom_16_slices_96_112',
    shape=(192, 256, 16),
    path_prefix='ukb_brain_mri',
    normalization=ZeroMeanStd1(),
    tensor_from_file=_slice_subset_tensor(
        't1_p2_1mm_fov256_sag_ti_880_1', 96, 112, 1, pad_shape=(192, 256, 208),
    ),
)
...
segmented_lax_4ch_50_frame_4d = TensorMap(
    ...
    shape=(96, 96, 50, 1),
    path_prefix='ukb_cardiac_mri', channel_map=MRI_LAX_4CH_SEGMENTED_CHANNEL_MAP,
    loss='sparse_categorical_crossentropy', metrics=['mse'],
    tensor_from_file=_segmented_heart_mask_instances('cine_segmented_lax_4ch_annotated_', LAX_4CH_HEART_LABELS, one_hot=False),
)
segmented_lax_4ch_48_frame_4d = TensorMap(
    'segmented_lax_4ch_48_frame_4d', Interpretation.CONTINUOUS,
    shape=(96, 96, 48, 1),
    loss='sparse_categorical_crossentropy',
    path_prefix='ukb_cardiac_mri', channel_map=MRI_LAX_4CH_SEGMENTED_CHANNEL_MAP,
    tensor_from_file=_segmented_heart_mask_instances('cine_segmented_lax_4ch_annotated_', LAX_4CH_HEART_LABELS, frames=48, one_hot=False),
