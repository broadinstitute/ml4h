...
class Dice:
    ...
    def dice(self, y_true, y_pred):
        ...
        y_true = batch_channel_flatten(y_true)
        y_pred = batch_channel_flatten(y_pred)
...
def dice(y_true, y_pred):
    return Dice(laplace_smoothing=0.05).loss(y_true, y_pred)
