...
-v /mnt/:/mnt/ \
-p 0.0.0.0:${PORT}:${PORT} \
${DOCKER_IMAGE} /bin/bash -c "pip install -e /home/${USER}/ml; pip install opencv-python; apt update ; apt install git -y ; pip install pylama ; jupyter notebook --no-browser --ip=0.0.0.0 --port=${PORT} --NotebookApp.token= --allow-root --notebook-dir=/home/${USER}"
