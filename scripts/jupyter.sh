...
-v /mnt/:/mnt/ \
-p 0.0.0.0:${PORT}:${PORT} \
${DOCKER_IMAGE} /bin/bash -c "pip3 install /home/${USER}/ml4h; jupyter notebook --no-browser --ip=0.0.0.0 --port=${PORT} --NotebookApp.token= --allow-root --notebook-dir=/home/${USER}"
