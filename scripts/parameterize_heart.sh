...
do
    ...
    /home/pdiachil/ml/scripts/tf.sh -c /home/pdiachil/ml/notebooks/mri/parameterize_la_geom.py $i $end
done

cd /home/pdiachil/ml/notebooks/mri
/snap/bin/gsutil cp *processed* gs://ml4cvd/pdiachil/surface_reconstruction/sax_4ch/fastai_sax-v20201202-2ch-v20200809-3ch-v20200603-4ch-v20201122/csv/
...
/snap/bin/gsutil cp poisson* gs://ml4cvd/pdiachil/surface_reconstruction/2ch_3ch_4ch/fastai_sax-v20201202-2ch-v20200809-3ch-v20200603-4ch-v20201122/xdmf/
/snap/bin/gsutil cp /home/pdiachil/out* gs://ml4cvd/pdiachil/surface_reconstruction/2ch_3ch_4ch/fastai_sax-v20201202-2ch-v20200809-3ch-v20200603-4ch-v20201122/log/
