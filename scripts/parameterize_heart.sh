...
do
    ...
    if [[ $? == 1 ]]
    then
        /home/pdiachil/ml/scripts/tf.sh -c "python /home/pdiachil/ml/notebooks/mri/parameterize_la_geom.py $i $end"
    fi 
done

cd /home/pdiachil/ml/notebooks/mri
/snap/bin/gsutil cp *processed* gs://ml4cvd/pdiachil/surface_reconstruction/2ch_4ch/fastai_sax-v20201202-2ch-v20200809-3ch-v20200603-4ch-v20201122/csv/
