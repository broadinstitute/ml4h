...
/snap/bin/gsutil cp /home/pdiachil/chambers/*.gif gs://ml4cvd/pdiachil/lvot_diameter/gif/
/snap/bin/gsutil cp /home/pdiachil/chambers/*.csv gs://ml4cvd/pdiachil/lvot_diameter/csv/
