...
-v ${HOME}/:${HOME}/ \
${MOUNTS} \
${DOCKER_IMAGE} /bin/bash -c "pip install ${WORKDIR}; pip install opencv-python ; cd /home/pdiachil/pypoisson ; python setup.py install ; cd ${WORKDIR}/notebooks/mri; ${PYTHON_COMMAND} ${PYTHON_ARGS}"
