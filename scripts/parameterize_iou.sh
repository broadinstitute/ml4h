...
do
    ...
    /home/pdiachil/ml/scripts/tf.sh -c /home/pdiachil/ml/notebooks/mri/iou_rv_geom.py $i $end
done

cd /home/pdiachil/ml/notebooks/mri
/snap/bin/gsutil cp *iou* gs://ml4cvd/pdiachil/rightheart_boundary_40k_v20201102/
