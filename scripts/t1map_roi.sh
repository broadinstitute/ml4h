...
do
    ...
    /snap/bin/gsutil cp *.csv gs://ml4cvd/pdiachil/t1map-pngs/inference_rois_iqr_3px/csv/
    /snap/bin/gsutil cp *.png gs://ml4cvd/pdiachil/t1map-pngs/inference_rois_iqr_3px/png/
