...
def main(
    ...
    if extract_embeddings:
        output_folder = os.path.join(output_dir,
                                     f'inference_embeddings_{vois}_{ufm}_{lmdb_folder.split("/")[-2]}_{splits_file}_{start_beat}')
    else:
        output_folder = os.path.join(output_dir,
                                     f'inference_{vois}_{ufm}_{lmdb_folder.split("/")[-2]}_{splits_file}_{start_beat}')
