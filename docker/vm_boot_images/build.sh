...
BASE_IMAGE_GPU="tensorflow/tensorflow:2.8.2-gpu"
BASE_IMAGE_CPU="tensorflow/tensorflow:2.8.2"

LATEST_TAG_GPU="tf2.8-latest-gpu"
LATEST_TAG_CPU="tf2.8-latest-cpu"
