...
from ml4cvd.defines import ECG_REST_AMP_LEADS, PARTNERS_DATE_FORMAT, STOP_CHAR, PARTNERS_CHAR_2_IDX, PARTNERS_DATETIME_FORMAT, ECG_REST_UKB_LEADS
...
TMAPS['partners_ecg_2500_raw'] = TensorMap('ecg_rest_2500_raw', shape=(None, 2500, 12), path_prefix=PARTNERS_PREFIX, tensor_from_file=make_voltage(population_normalize=2000.0), channel_map=ECG_REST_AMP_LEADS, time_series_limit=6)
...
TMAPS['partners_ecg_5000_raw_newest_ukb'] = TensorMap('ecg_rest_raw', shape=(5000, 12), path_prefix=PARTNERS_PREFIX, tensor_from_file=make_voltage(population_normalize=2000.0), channel_map=ECG_REST_UKB_LEADS)
...
def _field_to_index_from_map(value: str, follow_up_start: datetime.datetime, field_map: Dict[str, float] = {'F': 0, 'M': 1}) -> float:
...
def csv_field_tensor_from_file(
    file_name: str, patient_column: str = 'Mrn', value_column: str = 'birth_date', value_transform: Callable = _date_field_to_age,
        follow_up_start_column: str = 'start_fu', delimiter: str = ','
) -> Callable:
