...
def test_train_valid_tensor_generators(
    ...
    **kwargs
    ...
    generate_test = TensorGenerator(batch_size, tensor_maps_in, tensor_maps_out+tensor_maps_protected, test_paths, num_workers, 0, weights, keep_paths or keep_paths_test, name='test_worker', siamese=siamese, augment=False)
