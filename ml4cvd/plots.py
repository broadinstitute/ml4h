...
def plot_survival(prediction, truth, title, days_window=1825, prefix='./figures/', paths=None, top_k=3, alpha=0.5):
    ...
    logging.info(f"Prediction  is: {prediction[:5,:5]} truth  is: {truth.shape[:5,:5]}")
    logging.info(f"Prediction  is: {prediction[:5, intervals:intervals+5]} truth  is: {truth.shape[:5, intervals:intervals+5]}")
