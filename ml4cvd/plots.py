...
def plot_survival_curves(prediction, truth, title, days_window=3650, prefix='./figures/', num_curves=50, paths=None):
    ...
    for i in range(truth.shape[0]):
        ...
        if sick[i] == 1:
            ...
            plt.plot(x_days, predicted_survivals[i], label=f'sick_{p}', color='red')
            ...
            plt.plot(x_days, predicted_survivals[i], label=f'ok_{p}_p:{predicted_survivals[i, -1]:0.2f}', color='green')
