...
class MultiModalMultiTask(Model):

    def __init__(  # TODO: a lot of this shouldn't be optional
            self,
            ...
            conv_y: int = None,
            conv_z: int = None,
            conv_regularize_rate: float = 0,
            conv_dilate: bool = None,
            u_connect: List[Tuple[TensorMap, TensorMap]] = None,
            pool_x: int = None,
            pool_y: int = None,
            pool_z: int = None,
            pool_type: str = None,
