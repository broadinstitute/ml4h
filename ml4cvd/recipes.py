...
from ml4cvd.explorations import sample_from_char_model, mri_dates, ecg_dates, predictions_to_pngs, plot_histograms_from_tensor_files, plot_while_learning, find_tensors
...
def run(args):
    try:
        ...
        if 'tensorize' == args.mode:
            ...
            plot_histograms_from_tensor_files(args.id, args.tensors, args.output_folder, args.num_samples, args.num_fields)
        else:
