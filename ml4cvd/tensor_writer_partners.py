...
def write_tensors_partners(a_id: str,
    ...
    fpath_hd5_dirs = _get_dirs_in_dir(fpath_hd5)
...
def _get_args():
    ...
    parser.add_argument('--xmls',
                        default='/data/partners/ecg_deid/',
                        help='directory containing xmls. Default: /data/partners_ecgs')
    parser.add_argument('--hd5s',
                        default='/data/partners/hd5_deid/',
                        help='directory with output hd5s. Default: /data/partners_ecgs/hd5')
...
def _remove_hd5_in_date_dir(fpath_xml_dir, fpath_hd5):
    ...
    if os.path.exists(fpath_hd5_dir):
        ...
        fpath_hd5_list = get_files_from_dir(fpath_hd5_dir, 'hd5')
...
def _convert_xml_to_hd5(fpath_xml, fpath_hd5):
    ...
    text_data = text_from_xml(fpath_xml)
...
if __name__ == '__main__':
    ...
    if os.path.exists(fpath_hd5):
        fpath_hd5_dirs = get_dirs_in_dir(fpath_hd5)
    ...
    print(f'XML directories: {args.xmls}')
    print(f'Destination hd5 files: {args.hd5s}')

    # Get all XML directories
    fpath_xml_dirs = get_dirs_in_dir(args.xmls)

    # Sort XML directories from newest to oldest
    fpath_xml_dirs.sort(reverse=False)

    print(fpath_xml_dirs)
    ...
    for fpath_xml_dir in fpath_xml_dirs:
        ...
        _remove_hd5_in_date_dir(fpath_xml_dir, args.hd5s)
