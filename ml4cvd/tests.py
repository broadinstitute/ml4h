...
class TestTrainingModels(unittest.TestCase):
    ...
    def test_train_categorical_mlp(self):
        ...
        expected = {
            'no_coronary_artery_disease_soft': 0.528143258213825, 'coronary_artery_disease_soft': 0.528143258213825,
    ...
    def test_train_mlp_cat36_pi(self):
        ...
        args.output_tensors = [
            'end_systole_volume', 'end_diastole_volume', 'ejection_fractionp',
        ...
        print('expected = ', performances)
        expected = {
            'end_systole_volume_pearson': -0.18898451656690726,
    ...
    def test_train_mri_sax_zoom(self):
        ...
        args.output_tensors = [
            'sax_inlinevf_zoom_mask_weighted', 'end_systole_volume', 'end_diastole_volume',
        ...
        print('expected = ', performances)
        expected = {
            'end_systole_volume_pearson': 0.010191148347492063,
    ...
    def test_train_mri_systole_diastole(self):
        ...
        args.output_tensors = [
            'mri_systole_diastole_segmented_weighted', 'end_systole_volume', 'end_diastole_volume',
            'ejection_fractionp', 'allergic_rhinitis', 'asthma', 'atrial_fibrillation_or_flutter',
            'back_pain', 'breast_cancer', 'coronary_artery_disease_soft', 'diabetes_type_2',
            'hypertension', 'myocardial_infarction',
        ]
        ...
        print('expected = ', performances)
        expected = {
            'background': 0.9997983811584907, 'ventricle': 0.3717467509311169, 'myocardium': 0.1753433358365212,
    ...
    def test_train_mri_systole_diastole_pi(self):
        ...
        print('expected = ', performances)
        expected = {
            'background': 0.9994056020189077, 'ventricle': 0.3217267098772595, 'myocardium': 0.13751608768060483,
...
class TestPretrainedModels(unittest.TestCase):
    ...
    def test_ecg(self):
        ...
        args.output_tensors = [
            'ecg_normal', 'ecg_rhythm', 'p-axis', 'p-duration', 'p-offset', 'p-onset',
        ...
        expected = {
            'Normal-ECG': 0.8752554358212905, 'Borderline-ECG': 0.5837728637728636,
    ...
    def test_segmenter(self):
        ...
        args.output_tensors = [
            'sax_inlinevf_zoom_mask', 'end_systole_volume', 'end_diastole_volume',
            'ejection_fractionp',
        ]
        args.batch_size = 3
        args.test_steps = 64
        ...
        performances = test_multimodal_multitask(args)
        expected = {
            'end_systole_volume_pearson': 0.6230096872484032, 'end_diastole_volume_pearson': 0.6701106883874123,
    ...
    def test_continuous_mlp(self):
        ...
        args.input_tensors = [
            '34_0', '1807_0', '1845_0', '1873_0', '1883_0', '2946_0', '3526_0', '3972_0', '3982_0',
        ...
        args.output_tensors = [
            'allergic_rhinitis', 'anxiety', 'asthma', 'atrial_fibrillation_or_flutter', 'back_pain',
        ...
        performances = test_multimodal_multitask(args)
        expected = {
            'no_allergic_rhinitis': 0.5381671339010805, 'allergic_rhinitis': 0.5381671339010806,
    ...
    def test_categorical_mlp(self):
        ...
        args.output_tensors = [
            'allergic_rhinitis', 'asthma', 'atrial_fibrillation_or_flutter', 'back_pain',
        ...
        performances = test_multimodal_multitask(args)
        expected = {
            'no_allergic_rhinitis': 0.8845998401962242, 'allergic_rhinitis': 0.8845998401962241,
