...
class TestTrainingModels(unittest.TestCase):
    def test_train_categorical_mlp(self):
        ...
        expected = {
            "no_coronary_artery_disease_soft": 0.4945240833284755,
            "coronary_artery_disease_soft": 0.4945240833284755,
            "no_diabetes_type_2": 0.5470901959163001,
            "diabetes_type_2": 0.5470910572382917,
            "no_hypertension": 0.4933869347607721,
            "hypertension": 0.49338678981369954,
            "no_myocardial_infarction": 0.5612242431079916,
            "myocardial_infarction": 0.5612242431079916,
        }
...
class TestPretrainedModels(unittest.TestCase):
    def test_ecg_regress(self):
        ...
        expected = {
            "PAxis_pearson": 0.6010829310005574,
            "PDuration_pearson": 0.334397562979115,
            "POffset_pearson": 0.8870224086564694,
            "POnset_pearson": 0.915672533398803,
            "PPInterval_pearson": 0.9843003466847959,
            "PQInterval_pearson": 0.9024483040343809,
            "QOffset_pearson": 0.7529739057566074,
            "QOnset_pearson": 0.7417930219416248,
            "QRSComplexes_pearson": 0.14711527713690073,
            "QRSDuration_pearson": 0.9000439573470225,
            "QTInterval_pearson": 0.9572200766158885,
            "QTCInterval_pearson": 0.919422124977152,
            "RAxis_pearson": 0.8858920261655899,
            "RRInterval_pearson": 0.985806047245532,
            "TOffset_pearson": 0.9446387492651126,
    ...
    def test_ecg_rhythm(self):
        ...
        print("expected = ", performances)
        expected = {
            "Normal_sinus_rhythm": 0.9824029566392662,
            "Sinus_bradycardia": 0.9918234160230809,
            "Marked_sinus_bradycardia": 0.9975368393759994,
            "Other_sinus_rhythm": 0.8898630136986301,
            "Atrial_fibrillation": 0.9869892718557407,
            "Other_rhythm": 0.7223864258347017,
        }
