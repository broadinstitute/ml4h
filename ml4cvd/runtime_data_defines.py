...
def get_resting_ecg_hd5_folder(sample_id):
    return FOLDERS[determine_runtime()][determine_dataset(sample_id)][
...
def get_mri_folders(sample_id):
    return [
        FOLDERS[determine_runtime()][determine_dataset(sample_id)][DataType.BRAIN_MRI],
        FOLDERS[determine_runtime()][determine_dataset(sample_id)][
            DataType.CARDIAC_MRI
        ],
    ]
