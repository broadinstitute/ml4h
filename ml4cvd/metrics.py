...
def asymmetric_outlier_mse(y_true, y_pred):
    ...
    top_over += 10.0 * K.maximum(y_true - 2.0, 0.0) * K.maximum(y_true - y_pred, 0.0) * mean_squared_error(y_true, y_pred)
    top_under = 10.0 * K.maximum(y_true - 2.0, 0.0) * K.maximum(y_pred - y_true, 0.0) * mean_squared_error(y_true, y_pred)
