...
TMAPS['genetic_caucasian'] = TensorMap('Genetic-ethnic-grouping_Caucasian_0_0', Interpretation.CATEGORICAL, path_prefix='categorical',
...
TMAPS['bmi_21'] = TensorMap(
    ...
    validator=make_range_validator(0, 300), normalization={'mean': 27.3397, 'std': 4.77216}, loss='logcosh',
)
