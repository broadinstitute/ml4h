...
TMAPS['ecg_coarse'] = TensorMap('ecg_coarse', group='categorical', loss=weighted_crossentropy([1.0, 120.0, 10.0], 'ecg_coarse'),
...
TMAPS['t1_brain_208z'] = TensorMap('t1_p2_1mm_fov256_sag_ti_880', (256, 256, 208), group='root_array')
