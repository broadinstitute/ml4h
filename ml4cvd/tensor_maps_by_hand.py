...
TMAPS['sax_all_diastole_segmented_16'] = TensorMap('sax_all_diastole_segmented', (256, 256, 16, 3), loss='categorical_crossentropy',  group='categorical', channel_map=MRI_SEGMENTED_CHANNEL_MAP)
...
TMAPS['sax_all_diastole_16'] = TensorMap('sax_all_diastole', (256, 256, 16, 1), dependent_map=TMAPS['sax_all_diastole_segmented_16'])
