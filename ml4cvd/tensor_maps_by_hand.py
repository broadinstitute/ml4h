...
from ml4cvd.metrics import (
    ...
    y_true_cubed_times_mse,
    y_true_squared_times_mse,
    y_true_squared_times_logcosh,
)
from ml4cvd.TensorMap import TensorMap, Interpretation, make_range_validator
from ml4cvd.tensor_from_file import TMAPS, normalized_first_date

diploid_cm = {"homozygous_reference": 0, "heterozygous": 1, "homozygous_variant": 2}
TMAPS["rs3829740"] = TensorMap(
    "rs3829740", Interpretation.CATEGORICAL, channel_map=diploid_cm,
)
TMAPS["rs2234962"] = TensorMap(
    "rs2234962", Interpretation.CATEGORICAL, channel_map=diploid_cm,
)
TMAPS["rs2042995"] = TensorMap(
    "rs2042995", Interpretation.CATEGORICAL, channel_map=diploid_cm,
)

TMAPS["rs3829740_weighted"] = TensorMap(
    "rs3829740",
    Interpretation.CATEGORICAL,
    channel_map=diploid_cm,
    loss=weighted_crossentropy([1, 1, 1.5], "rs3829740"),
)
TMAPS["rs2234962_weighted"] = TensorMap(
    "rs2234962",
    Interpretation.CATEGORICAL,
    channel_map=diploid_cm,
    loss=weighted_crossentropy([0.8, 1, 1.5], "rs2234962"),
)
TMAPS["rs2042995_weighted"] = TensorMap(
    "rs2042995",
    Interpretation.CATEGORICAL,
    channel_map=diploid_cm,
    loss=weighted_crossentropy([0.6, 1.5, 2], "rs2042995"),
)
...
TMAPS["ryr2_lof"] = TensorMap(
    "RYR2", Interpretation.CATEGORICAL, channel_map={"no_ryr2_lof": 0, "ryr2_lof": 1},
)
TMAPS["ttn_lof"] = TensorMap(
    "TTN", Interpretation.CATEGORICAL, channel_map={"no_ttn_lof": 0, "ttn_lof": 1},
)
...
TMAPS["ecg_semi_coarse"] = TensorMap(
    ...
    channel_map={
        ...
        "Sinus_bradycardia": 1,
        "Marked_sinus_bradycardia": 2,
        "Other_sinus_rhythm": 3,
...
TMAPS["ecg_semi_coarse_with_poor"] = TensorMap(
    "ecg_semi_coarse_with_poor",
    Interpretation.CATEGORICAL,
    loss=weighted_crossentropy(
        [1.0, 2.0, 3.0, 3.0, 20.0, 20.0], "ecg_semi_coarse_with_poor",
    ),
    channel_map={
        "Normal_sinus_rhythm": 0,
        "Sinus_bradycardia": 1,
...
TMAPS["ecg_normal"] = TensorMap(
    "ecg_normal",
    Interpretation.CATEGORICAL,
    loss=weighted_crossentropy([2.0, 3.0, 3.0, 3.0], "ecg_normal"),
    channel_map={
        "Normal_ECG": 0,
        "Abnormal_ECG": 1,
        "Borderline_ECG": 2,
        "Otherwise_normal_ECG": 3,
    },
)
TMAPS["ecg_infarct"] = TensorMap(
    "ecg_infarct",
    Interpretation.CATEGORICAL,
    channel_map={"no_infarct": 0, "infarct": 1},
    loss=weighted_crossentropy([1.0, 8.0], "ecg_infarct"),
)
TMAPS["ecg_poor_data"] = TensorMap(
    "ecg_poor_data",
    Interpretation.CATEGORICAL,
    channel_map={"no_poor_data_quality": 0, "poor_data_quality": 1},
    loss=weighted_crossentropy([1.0, 8.0], "ecg_poor_data"),
)
TMAPS["ecg_block"] = TensorMap(
    "ecg_block",
    Interpretation.CATEGORICAL,
    channel_map={"no_block": 0, "block": 1},
    loss=weighted_crossentropy([1.0, 8.0], "ecg_block"),
)

TMAPS["ecg_rest_next_char"] = TensorMap(
    "ecg_rest_next_char",
...
TMAPS["ecg_rest_text"] = TensorMap(
    "ecg_rest_text",
    Interpretation.LANGUAGE,
    shape=(100, len(ECG_CHAR_2_IDX)),
    path_prefix="ukb_ecg_rest",
    channel_map={"context": 0, "alphabet": 1},
    dependent_map=TMAPS["ecg_rest_next_char"],
)
...
TMAPS["p-axis"] = TensorMap(
    ...
    channel_map={"PAxis": 0},
    loss="logcosh",
    validator=make_range_validator(-50, 130),
...
TMAPS["p-duration"] = TensorMap(
    ...
    Interpretation.CONTINUOUS,
    path_prefix="ukb_ecg_rest",
    channel_map={"PDuration": 0},
    loss="logcosh",
    validator=make_range_validator(30, 140),
...
TMAPS["p-offset"] = TensorMap(
    ...
    Interpretation.CONTINUOUS,
    path_prefix="ukb_ecg_rest",
    channel_map={"POffset": 0},
    loss="logcosh",
    validator=make_range_validator(200, 500),
...
TMAPS["p-onset"] = TensorMap(
    ...
    Interpretation.CONTINUOUS,
    path_prefix="ukb_ecg_rest",
    channel_map={"POnset": 0},
    loss="logcosh",
    validator=make_range_validator(120, 400),
...
TMAPS["pp-interval"] = TensorMap(
    ...
    Interpretation.CONTINUOUS,
    path_prefix="ukb_ecg_rest",
    channel_map={"PPInterval": 0},
    loss="logcosh",
    validator=make_range_validator(300, 1800),
...
TMAPS["pq-interval"] = TensorMap(
    ...
    Interpretation.CONTINUOUS,
    path_prefix="ukb_ecg_rest",
    channel_map={"PQInterval": 0},
    loss="logcosh",
    validator=make_range_validator(70, 400),
...
TMAPS["q-offset"] = TensorMap(
    ...
    Interpretation.CONTINUOUS,
    path_prefix="ukb_ecg_rest",
    channel_map={"QOffset": 0},
    loss="logcosh",
    validator=make_range_validator(300, 600),
...
TMAPS["q-onset"] = TensorMap(
    ...
    Interpretation.CONTINUOUS,
    path_prefix="ukb_ecg_rest",
    channel_map={"QOnset": 0},
    loss="logcosh",
    validator=make_range_validator(370, 600),
...
TMAPS["qrs-complexes"] = TensorMap(
    ...
    Interpretation.CONTINUOUS,
    path_prefix="ukb_ecg_rest",
    channel_map={"QRSComplexes": 0},
    loss="logcosh",
    validator=make_range_validator(0, 60),
...
TMAPS["qrs-duration"] = TensorMap(
    ...
    loss="logcosh",
    validator=make_range_validator(45, 175),
...
TMAPS["qrs-num"] = TensorMap(
    ...
    Interpretation.CONTINUOUS,
    path_prefix="ukb_ecg_rest",
    channel_map={"QRSNum": 0},
    loss="logcosh",
    validator=make_range_validator(2, 30),
...
TMAPS["r-axis"] = TensorMap(
    ...
    channel_map={"RAxis": 0},
    loss="logcosh",
    validator=make_range_validator(-100, 200),
...
TMAPS["rr-interval"] = TensorMap(
    ...
    Interpretation.CONTINUOUS,
    path_prefix="ukb_ecg_rest",
    channel_map={"RRInterval": 0},
    loss="logcosh",
    validator=make_range_validator(400, 2000),
...
TMAPS["ventricular-rate"] = TensorMap(
    ...
    validator=make_range_validator(30, 150),
    loss="logcosh",
...
TMAPS["t-offset"] = TensorMap(
    ...
    Interpretation.CONTINUOUS,
    path_prefix="ukb_ecg_rest",
    channel_map={"TOffset": 0},
    loss="logcosh",
    validator=make_range_validator(700, 1000),
...
TMAPS["af_prs"] = TensorMap(
    "AF_PRS_LDscore",
    Interpretation.CONTINUOUS,
    path_prefix="ukb_ecg_rest",
    channel_map={"AF_PRS_LDscore": 0},
    normalization={"mean": -1.0, "std": 0.4},
)
TMAPS["charge"] = TensorMap(
    "charge",
    Interpretation.CONTINUOUS,
    path_prefix="ukb_ecg_rest",
    channel_map={"charge": 0},
    normalization={"mean": 12.0, "std": 2.0},
...
TMAPS["qtc-intervalp"] = TensorMap(
    ...
    channel_map={"QTCInterval": 0},
    loss="logcosh",
    validator=make_range_validator(100, 900),
...
TMAPS["r-axis-sentinel"] = TensorMap(
    "RAxis",
    Interpretation.CONTINUOUS,
    path_prefix="ukb_ecg_rest",
    channel_map={"RAxis": 0},
...
TMAPS["t-axis-sentinel"] = TensorMap(
    "TAxis",
    Interpretation.CONTINUOUS,
    path_prefix="ukb_ecg_rest",
    channel_map={"TAxis": 0},
...
TMAPS["class1_fu"] = TensorMap(
    "class1_fu",
    Interpretation.CATEGORICAL,
    channel_map={"no_class1_fu": 0, "class1_fu": 1},
    loss_weight=100.0,
    loss=weighted_crossentropy([0.0018, 0.9982], "class1_fu"),
)
TMAPS["bb_fu"] = TensorMap(
    "bb_fu",
    Interpretation.CATEGORICAL,
    channel_map={"no_bb_fu": 0, "bb_fu": 1},
    loss_weight=100.0,
    loss=weighted_crossentropy([0.0306, 0.9694], "bb_fu"),
)
TMAPS["class3_fu"] = TensorMap(
    "class3_fu",
    Interpretation.CATEGORICAL,
    channel_map={"no_class3_fu": 0, "class3_fu": 1},
    loss_weight=100.0,
    loss=weighted_crossentropy([0.0006, 0.9994], "class3_fu"),
)
TMAPS["ccb_fu"] = TensorMap(
    "ccb_fu",
    Interpretation.CATEGORICAL,
    channel_map={"no_ccb_fu": 0, "ccb_fu": 1},
    loss_weight=100.0,
    loss=weighted_crossentropy([0.0035, 0.9965], "ccb_fu"),
)
TMAPS["qtc_drug_def_fu"] = TensorMap(
    "qtc_drug_def_fu",
    Interpretation.CATEGORICAL,
    channel_map={"no_qtc_drug_def_fu": 0, "qtc_drug_def_fu": 1},
    loss_weight=100.0,
    loss=weighted_crossentropy([0.0140, 0.9860], "qtc_drug_def_fu"),
)
TMAPS["qtc_drug_poss_fu"] = TensorMap(
    "qtc_drug_poss_fu",
    Interpretation.CATEGORICAL,
    channel_map={"no_qtc_drug_poss_fu": 0, "qtc_drug_poss_fu": 1},
    loss_weight=100.0,
    loss=weighted_crossentropy([0.0127, 0.9873], "qtc_drug_poss_fu"),
)
TMAPS["qtc_drug_def_any"] = TensorMap(
    "qtc_drug_def_any",
    Interpretation.CATEGORICAL,
    channel_map={"no_qtc_drug_def_any": 0, "qtc_drug_def_any": 1},
    loss_weight=100.0,
    loss=weighted_crossentropy([0.0302, 0.9698], "qtc_drug_def_any"),
)
TMAPS["qtc_drug_poss_any"] = TensorMap(
    "qtc_drug_poss_any",
    Interpretation.CATEGORICAL,
    channel_map={"no_qtc_drug_poss_any": 0, "qtc_drug_poss_any": 1},
    loss_weight=100.0,
    loss=weighted_crossentropy([0.0267, 0.9733], "qtc_drug_poss_any"),
)
TMAPS["any_class1"] = TensorMap(
    "any_class1",
    Interpretation.CATEGORICAL,
    channel_map={"no_any_class1": 0, "any_class1": 1},
    loss_weight=100.0,
    loss=weighted_crossentropy([0.0031, 0.9969], "any_class1"),
)
TMAPS["any_bb"] = TensorMap(
    "any_bb",
    Interpretation.CATEGORICAL,
    channel_map={"no_any_bb": 0, "any_bb": 1},
    loss_weight=100.0,
    loss=weighted_crossentropy([0.0602, 0.9398], "any_bb"),
)
TMAPS["any_class3"] = TensorMap(
    "any_class3",
    Interpretation.CATEGORICAL,
    channel_map={"no_any_class3": 0, "any_class3": 1},
    loss_weight=100.0,
    loss=weighted_crossentropy([0.0013, 0.9987], "any_class3"),
)
TMAPS["any_ccb"] = TensorMap(
    "any_ccb",
    Interpretation.CATEGORICAL,
    channel_map={"no_any_ccb": 0, "any_ccb": 1},
    loss_weight=100.0,
...
TMAPS["combined_qtc_drug_fu"] = TensorMap(
    "combined_qtc_drug_fu",
    Interpretation.CATEGORICAL,
    channel_map={"no_combined_qtc_drug_fu": 0, "combined_qtc_drug_fu": 1},
    loss_weight=100.0,
    loss=weighted_crossentropy([0.0260, 0.9740], "combined_qtc_drug_fu"),
)
TMAPS["combined_qtc_drug_any"] = TensorMap(
    "combined_qtc_drug_any",
    Interpretation.CATEGORICAL,
...
TMAPS["ecg-bike-max-hr-no0"] = TensorMap(
    "bike_max_hr",
    Interpretation.CONTINUOUS,
    channel_map={"bike_max_hr": 0},
    loss=ignore_zeros_logcosh,
    metrics=["logcosh"],
...
TMAPS["ecg-bike-resting-hr-no0"] = TensorMap(
    "bike_resting_hr",
    Interpretation.CONTINUOUS,
    channel_map={"bike_resting_hr": 0},
    loss=ignore_zeros_logcosh,
    metrics=["logcosh"],
    normalization={"mean": 71.2, "std": 12.57},
)
TMAPS["ecg-bike-max-pred-hr-no0"] = TensorMap(
    "bike_max_pred_hr",
    Interpretation.CONTINUOUS,
    channel_map={"bike_max_pred_hr": 0},
    loss=ignore_zeros_logcosh,
    metrics=["logcosh"],
    normalization={"mean": 167.5, "std": 5.78},
)

TMAPS["weight_kg"] = TensorMap(
    "weight_kg",
    Interpretation.CONTINUOUS,
    normalization={"mean": 76.54286701805927, "std": 15.467605416933122},
    loss="logcosh",
    channel_map={"weight_kg": 0},
)
TMAPS["height_cm"] = TensorMap(
    "height_cm",
    Interpretation.CONTINUOUS,
    normalization={"mean": 169.18064748408653, "std": 9.265265197273026},
    loss="logcosh",
    channel_map={"height_cm": 0},
)
TMAPS["bmi_bsa"] = TensorMap(
    "bmi",
    Interpretation.CONTINUOUS,
    normalization={"mean": 26.65499238706321, "std": 4.512077188749083},
    loss="logcosh",
    channel_map={"bmi": 0},
)
TMAPS["bsa_mosteller"] = TensorMap(
    "bsa_mosteller",
    Interpretation.CONTINUOUS,
    normalization={"mean": 1.8894831981880114, "std": 0.22169301057810176},
    loss="logcosh",
    channel_map={"bsa_mosteller": 0},
)
TMAPS["bsa_dubois"] = TensorMap(
    "bsa_dubois",
    Interpretation.CONTINUOUS,
    normalization={"mean": 1.8671809970639703, "std": 0.20913930961120797},
    loss="logcosh",
...
TMAPS["lv_mass"] = TensorMap(
    ...
    activation="linear",
    loss="logcosh",
    validator=make_range_validator(0, 500),
    channel_map={"lv_mass": 0},
...
TMAPS["LVM_sentinel"] = TensorMap(
    ...
    sentinel=0,
    validator=make_range_validator(-1, 300),
    channel_map={"LVM": 0},
)
TMAPS["lv_mass_prediction"] = TensorMap(
    "lv_mass_sentinel_prediction",
    Interpretation.CONTINUOUS,
    activation="linear",
    loss="logcosh",
    loss_weight=10.0,
    validator=make_range_validator(0, 300),
    channel_map={"lv_mass_sentinel_prediction": 0},
    normalization={"mean": 89.7, "std": 24.8},
)
TMAPS["lv_mass_dubois_index_prediction"] = TensorMap(
    "lv_mass_dubois_index_sentinel_prediction",
    Interpretation.CONTINUOUS,
    activation="linear",
    loss="logcosh",
    validator=make_range_validator(0, 300),
    loss_weight=10.0,
    channel_map={"lv_mass_dubois_index_sentinel_prediction": 0},
    normalization={"mean": 89.7, "std": 24.8},
)
TMAPS["lv_mass_mosteller_index_prediction"] = TensorMap(
    "lv_mass_mosteller_index_sentinel_prediction",
    Interpretation.CONTINUOUS,
    activation="linear",
    loss="logcosh",
    validator=make_range_validator(0, 300),
...
TMAPS["LVM_prediction"] = TensorMap(
    "LVM_sentinel_prediction",
    Interpretation.CONTINUOUS,
    normalization={"mean": 89.70372484725051, "std": 24.803669503436304},
    validator=make_range_validator(0, 300),
    channel_map={"LVM_sentinel_prediction": 0},
)

TMAPS["lvm_dubois_index_prediction"] = TensorMap(
    "lvm_dubois_index_sentinel_prediction",
    Interpretation.CONTINUOUS,
    activation="linear",
    loss="logcosh",
    validator=make_range_validator(0, 300),
    channel_map={"lvm_dubois_index_sentinel_prediction": 0},
    normalization={"mean": 42.0, "std": 8.0},
)
TMAPS["lvm_mosteller_index_prediction"] = TensorMap(
    "lvm_mosteller_index_sentinel_prediction",
    Interpretation.CONTINUOUS,
    activation="linear",
    loss="logcosh",
    validator=make_range_validator(0, 300),
...
TMAPS["end_systole_volume"] = TensorMap(
    ...
    validator=make_range_validator(0, 300),
    loss="logcosh",
    channel_map={"end_systole_volume": 0},
...
TMAPS["end_diastole_volume"] = TensorMap(
    ...
    Interpretation.CONTINUOUS,
    activation="linear",
    validator=make_range_validator(0, 400),
    loss="logcosh",
    channel_map={"end_diastole_volume": 0},
...
TMAPS["ejection_fraction"] = TensorMap(
    ...
    Interpretation.CONTINUOUS,
    activation="linear",
    validator=make_range_validator(0.2, 0.9),
...
TMAPS["corrected_extracted_lvedv"] = TensorMap(
    "corrected_extracted_lvedv",
    Interpretation.CONTINUOUS,
    activation="linear",
    validator=make_range_validator(0, 400),
    loss="logcosh",
    channel_map={"corrected_extracted_lvedv": 0},
    normalization={"mean": 142.0, "std": 21.0},
)
TMAPS["corrected_extracted_lvef"] = TensorMap(
    "corrected_extracted_lvef",
    Interpretation.CONTINUOUS,
    activation="linear",
    validator=make_range_validator(0.2, 0.9),
    normalization={"mean": 0.50, "std": 0.046},
    loss="logcosh",
    channel_map={"corrected_extracted_lvef": 0},
)
TMAPS["corrected_extracted_lvesv"] = TensorMap(
    "corrected_extracted_lvesv",
    Interpretation.CONTINUOUS,
    activation="linear",
    validator=make_range_validator(0, 300),
    loss="logcosh",
    channel_map={"corrected_extracted_lvesv": 0},
    normalization={"mean": 47.0, "std": 10.0},
)
...
TMAPS["LA_2Ch_vol_max"] = TensorMap(
    "LA_2Ch_vol_max",
    Interpretation.CONTINUOUS,
    normalization={"mean": 63.45582391534391, "std": 22.548034481265972},
    validator=make_range_validator(0, 400),
    loss="logcosh",
    channel_map={"LA_2Ch_vol_max": 0},
)
TMAPS["LA_2Ch_vol_min"] = TensorMap(
    "LA_2Ch_vol_min",
    Interpretation.CONTINUOUS,
    normalization={"mean": 28.308681904761904, "std": 15.842444310837582},
    validator=make_range_validator(0, 200),
    loss="logcosh",
    channel_map={"LA_2Ch_vol_min": 0},
)
TMAPS["LA_4Ch_vol_max"] = TensorMap(
    "LA_4Ch_vol_max",
    Interpretation.CONTINUOUS,
    normalization={"mean": 74.53903305263158, "std": 25.448756860639776},
    validator=make_range_validator(0, 400),
    loss="logcosh",
    channel_map={"LA_4Ch_vol_max": 0},
)
TMAPS["LA_4Ch_vol_min"] = TensorMap(
    "LA_4Ch_vol_min",
    Interpretation.CONTINUOUS,
    normalization={"mean": 31.014961894736846, "std": 17.146722819760804},
    validator=make_range_validator(0, 200),
    loss="logcosh",
    channel_map={"LA_4Ch_vol_min": 0},
)
TMAPS["LA_Biplan_vol_max"] = TensorMap(
    "LA_Biplan_vol_max",
    Interpretation.CONTINUOUS,
    normalization={"mean": 67.86355108225109, "std": 21.793845470012105},
    validator=make_range_validator(0, 400),
    loss="logcosh",
    channel_map={"LA_Biplan_vol_max": 0},
)
TMAPS["LA_Biplan_vol_min"] = TensorMap(
    "LA_Biplan_vol_min",
    Interpretation.CONTINUOUS,
    normalization={"mean": 28.79685670995671, "std": 15.43219634139272},
    validator=make_range_validator(0, 300),
    loss="logcosh",
    channel_map={"LA_Biplan_vol_min": 0},
)
TMAPS["LVEDV"] = TensorMap(
    "LVEDV",
    Interpretation.CONTINUOUS,
    normalization={"mean": 144.1479505192425, "std": 34.39409859908663},
    loss="logcosh",
    validator=make_range_validator(0, 500),
    channel_map={"LVEDV": 0},
)
TMAPS["LVESV"] = TensorMap(
    "LVESV",
    Interpretation.CONTINUOUS,
    normalization={"mean": 59.58324862553452, "std": 21.186976544044025},
    loss="logcosh",
    validator=make_range_validator(0, 400),
    channel_map={"LVESV": 0},
)
...
TMAPS["LVSV"] = TensorMap(
    "LVSV",
    Interpretation.CONTINUOUS,
    normalization={"mean": 84.85198120147119, "std": 19.2700091046526},
    loss="logcosh",
    validator=make_range_validator(0, 400),
    channel_map={"LVSV": 0},
)
TMAPS["RA_4Ch_vol_max"] = TensorMap(
    "RA_4Ch_vol_max",
    Interpretation.CONTINUOUS,
    normalization={"mean": 79.22289586811351, "std": 26.504015552539048},
    validator=make_range_validator(0, 500),
    loss="logcosh",
    channel_map={"RA_4Ch_vol_max": 0},
)
TMAPS["RA_4Ch_vol_min"] = TensorMap(
    "RA_4Ch_vol_min",
    Interpretation.CONTINUOUS,
    normalization={"mean": 46.25831176961603, "std": 20.002160080524803},
    validator=make_range_validator(0, 400),
    loss="logcosh",
    channel_map={"RA_4Ch_vol_min": 0},
)
TMAPS["RVEDV"] = TensorMap(
    "RVEDV",
    Interpretation.CONTINUOUS,
    normalization={"mean": 152.41239853151131, "std": 37.15198900632509},
    loss="logcosh",
    validator=make_range_validator(0, 500),
    channel_map={"RVEDV": 0},
)
TMAPS["RVEF"] = TensorMap(
    "RVEF",
    Interpretation.CONTINUOUS,
    normalization={"mean": 56.404863078182565, "std": 6.526231365539632},
    loss="logcosh",
...
TMAPS["RVESV"] = TensorMap(
    "RVESV",
    Interpretation.CONTINUOUS,
    normalization={"mean": 67.61379869467673, "std": 22.853189258914284},
    loss="logcosh",
    validator=make_range_validator(0, 300),
    channel_map={"RVESV": 0},
)
TMAPS["RVSV"] = TensorMap(
    "RVSV",
    Interpretation.CONTINUOUS,
    normalization={"mean": 85.0908258288989, "std": 19.30893645374548},
    loss="logcosh",
    validator=make_range_validator(0, 200),
    channel_map={"RVSV": 0},
)
TMAPS["LAQC"] = TensorMap(
    "LAQC",
    Interpretation.CONTINUOUS,
    normalization={"mean": 1.2657977883096367, "std": 0.5561369836438385},
    loss="logcosh",
    validator=make_range_validator(0, 200),
    channel_map={"LAQC": 0},
)
TMAPS["LVQC"] = TensorMap(
    "LVQC",
    Interpretation.CONTINUOUS,
    normalization={"mean": 1.1737756714060033, "std": 0.4620420984104567},
    loss="logcosh",
    validator=make_range_validator(0, 200),
    channel_map={"LVQC": 0},
)
TMAPS["RAQC"] = TensorMap(
    "RAQC",
    Interpretation.CONTINUOUS,
    normalization={"mean": 1.1860189573459716, "std": 0.4791815490882246},
    loss="logcosh",
    validator=make_range_validator(0, 200),
    channel_map={"RAQC": 0},
)
TMAPS["RVQC"] = TensorMap(
    "RVQC",
    Interpretation.CONTINUOUS,
    normalization={"mean": 1.179699842022117, "std": 0.4648958893626213},
    loss="logcosh",
    validator=make_range_validator(0, 200),
    channel_map={"RVQC": 0},
)
...
TMAPS["adjusted_myocardium_mass_sentinel"] = TensorMap(
    ...
    path_prefix="continuous",
    loss="logcosh",
    channel_map={"adjusted_myocardium_mass": 0},
    normalization={"mean": 89.70, "std": 24.80},
    sentinel=0.0,
)
...
TMAPS["adjusted_myocardium_mass_y_true_sqr_logcosh"] = TensorMap(
    ...
    Interpretation.CONTINUOUS,
    validator=make_range_validator(0, 400),
    loss=y_true_squared_times_logcosh,
    channel_map={"adjusted_myocardium_mass": 0},
    path_prefix="continuous",
    normalization={"mean": 89.70, "std": 24.80},
)
...
TMAPS["proton_fat"] = TensorMap(
    "22402_Proton-density-fat-fraction-PDFF_2_0",
    Interpretation.CONTINUOUS,
    channel_map={"22402_Proton-density-fat-fraction-PDFF_2_0": 0},
    activation="linear",
    loss="logcosh",
    annotation_units=1,
    path_prefix="continuous",
    validator=make_range_validator(0, 100),
    normalization={"mean": 3.91012, "std": 4.64437},
)
TMAPS["liver_fat"] = TensorMap(
    "22402_Liver-fat-percentage_2_0",
    Interpretation.CONTINUOUS,
    channel_map={"22402_Liver-fat-percentage_2_0": 0},
    activation="linear",
    loss="logcosh",
    annotation_units=1,
    path_prefix="continuous",
...
TMAPS["liver_fat_echo_predicted"] = TensorMap(
    ...
    Interpretation.CONTINUOUS,
    channel_map={"liver_fat_sentinel_prediction": 0},
    validator=make_range_validator(0, 100),
    normalization={"mean": 3.91012, "std": 4.64437},
    path_prefix="continuous",
    activation="linear",
...
TMAPS["gre_mullti_echo_10_te_liver"] = TensorMap(
    "gre_mullti_echo_10_te_liver",
    shape=(160, 160, 10),
    loss="logcosh",
    normalization={"zero_mean_std1": 1.0},
)
TMAPS["gre_mullti_echo_10_te_liver_12bit"] = TensorMap(
    "gre_mullti_echo_10_te_liver_12bit",
    shape=(160, 160, 10),
    loss="logcosh",
    normalization={"zero_mean_std1": 1.0},
)
TMAPS["lms_ideal_optimised_low_flip_6dyn"] = TensorMap(
    "lms_ideal_optimised_low_flip_6dyn",
    shape=(232, 256, 36),
    loss="logcosh",
    normalization={"zero_mean_std1": 1.0},
)
TMAPS["lms_ideal_optimised_low_flip_6dyn_12bit"] = TensorMap(
    "lms_ideal_optimised_low_flip_6dyn_12bit",
    shape=(232, 256, 36),
    loss="logcosh",
    normalization={"zero_mean_std1": 1.0},
)
TMAPS["lms_ideal_optimised_low_flip_6dyn_4slice"] = TensorMap(
    "lms_ideal_optimised_low_flip_6dyn_4slice",
    shape=(232, 256, 4),
    loss="logcosh",
    normalization={"zero_mean_std1": 1.0},
)

TMAPS["shmolli_192i"] = TensorMap(
    "shmolli_192i", shape=(288, 384, 7), normalization={"zero_mean_std1": 1.0},
)
TMAPS["shmolli_192i_liver"] = TensorMap(
    "shmolli_192i_liver", shape=(288, 384, 7), normalization={"zero_mean_std1": 1.0},
)
TMAPS["shmolli_192i_12bit"] = TensorMap(
...
TMAPS["sax_pixel_width"] = TensorMap(
    "mri_pixel_width_cine_segmented_sax_inlinevf",
    Interpretation.CONTINUOUS,
    annotation_units=2,
    channel_map={"mri_pixel_width_cine_segmented_sax_inlinevf": 0},
    validator=make_range_validator(0, 4),
    normalization={"mean": 1.83, "std": 0.1},
)
TMAPS["sax_pixel_height"] = TensorMap(
    "mri_pixel_height_segmented_sax_inlinevf",
    Interpretation.CONTINUOUS,
    annotation_units=2,
    channel_map={"mri_pixel_height_cine_segmented_sax_inlinevf": 0},
    validator=make_range_validator(0, 4),
    normalization={"mean": 1.83, "std": 0.1},
)
...
TMAPS["cine_segmented_sax_b1"] = TensorMap(
    "cine_segmented_sax_b1", shape=(256, 256, 50), loss="mse",
)
TMAPS["cine_segmented_sax_b2"] = TensorMap(
    "cine_segmented_sax_b2", shape=(256, 256, 50), loss="mse",
)
TMAPS["cine_segmented_sax_b4"] = TensorMap(
    "cine_segmented_sax_b4", shape=(256, 256, 50), loss="mse",
)
TMAPS["cine_segmented_sax_b6"] = TensorMap(
    "cine_segmented_sax_b6", shape=(256, 256, 50), loss="mse",
)

TMAPS["cine_segmented_lax_2ch"] = TensorMap(
    "cine_segmented_lax_2ch",
    shape=(256, 256, 50),
    normalization={"zero_mean_std1": True},
)
TMAPS["cine_segmented_lax_3ch"] = TensorMap(
    "cine_segmented_lax_3ch",
    shape=(256, 256, 50),
    normalization={"zero_mean_std1": True},
)
TMAPS["cine_segmented_lax_4ch"] = TensorMap(
    "cine_segmented_lax_4ch",
    shape=(256, 256, 50),
    normalization={"zero_mean_std1": True},
)

TMAPS["cine_segmented_lax_2ch_4d"] = TensorMap(
    "cine_segmented_lax_2ch_4d",
    shape=(256, 256, 50, 1),
    normalization={"zero_mean_std1": True},
)
TMAPS["cine_segmented_lax_3ch_4d"] = TensorMap(
    "cine_segmented_lax_3ch_4d",
    shape=(256, 256, 50, 1),
    normalization={"zero_mean_std1": True},
)
TMAPS["cine_segmented_lax_4ch_4d"] = TensorMap(
    "cine_segmented_lax_4ch_4d",
    shape=(256, 256, 50, 1),
    normalization={"zero_mean_std1": True},
)
...
TMAPS["lax-view-detect"] = TensorMap(
    ...
    Interpretation.CATEGORICAL,
    channel_map={
        "cine_segmented_lax_2ch": 0,
        "cine_segmented_lax_3ch": 1,
...
TMAPS["sax-view-detect"] = TensorMap(
    ...
    Interpretation.CATEGORICAL,
    channel_map={
        "cine_segmented_sax_b1": 0,
        "cine_segmented_sax_b2": 1,
        "cine_segmented_sax_b3": 2,
        "cine_segmented_sax_b4": 3,
        "cine_segmented_sax_b5": 4,
        "cine_segmented_sax_b6": 5,
        "cine_segmented_sax_b7": 6,
        "cine_segmented_sax_b8": 7,
        "cine_segmented_sax_b9": 8,
        "cine_segmented_sax_b10": 9,
...
TMAPS["slax-view-detect"] = TensorMap(
    ...
    Interpretation.CATEGORICAL,
    channel_map={
        "cine_segmented_lax_2ch": 11,
        "cine_segmented_lax_3ch": 12,
        "cine_segmented_lax_4ch": 13,
        "cine_segmented_sax_b1": 0,
        "cine_segmented_sax_b2": 1,
        "cine_segmented_sax_b3": 2,
        "cine_segmented_sax_b4": 3,
...
TMAPS["genetic_pca_1"] = TensorMap(
    "22009_Genetic-principal-components_0_1",
    Interpretation.CONTINUOUS,
    path_prefix="continuous",
    normalization={"mean": -0.014422761536727896, "std": 10.57799283718005},
    loss="logcosh",
    channel_map={"22009_Genetic-principal-components_0_1": 0},
)
TMAPS["genetic_pca_2"] = TensorMap(
    "22009_Genetic-principal-components_0_2",
    Interpretation.CONTINUOUS,
    path_prefix="continuous",  # normalization={'mean': -0.014422761536727896, 'std': 10.57799283718005},
    loss="logcosh",
    activation="linear",
    channel_map={"22009_Genetic-principal-components_0_2": 0},
)
TMAPS["genetic_pca_3"] = TensorMap(
    "22009_Genetic-principal-components_0_3",
    Interpretation.CONTINUOUS,
    path_prefix="continuous",  # normalization={'mean': -0.014422761536727896, 'std': 10.57799283718005},
    loss="logcosh",
    activation="linear",
    channel_map={"22009_Genetic-principal-components_0_3": 0},
)
TMAPS["genetic_pca_4"] = TensorMap(
    "22009_Genetic-principal-components_0_4",
    Interpretation.CONTINUOUS,
    path_prefix="continuous",  # normalization={'mean': -0.014422761536727896, 'std': 10.57799283718005},
    loss="logcosh",
    activation="linear",
    channel_map={"22009_Genetic-principal-components_0_4": 0},
)
TMAPS["genetic_pca_5"] = TensorMap(
    "22009_Genetic-principal-components_0_5",
    Interpretation.CONTINUOUS,
    path_prefix="continuous",  # normalization={'mean': -0.014422761536727896, 'std': 10.57799283718005},
    loss="logcosh",
    activation="linear",
    channel_map={"22009_Genetic-principal-components_0_5": 0},
)
TMAPS["genetic_pca_all5"] = TensorMap(
    ...
    activation="linear",
    channel_map={
        "22009_Genetic-principal-components_0_0": 0,
        "22009_Genetic-principal-components_0_1": 1,
        "22009_Genetic-principal-components_0_2": 2,
        "22009_Genetic-principal-components_0_3": 3,
        "22009_Genetic-principal-components_0_4": 4,
    },
)

TMAPS["genetic_caucasian"] = TensorMap(
    "Genetic-ethnic-grouping_Caucasian_0_0",
    Interpretation.CATEGORICAL,
    path_prefix="categorical",
    channel_map={"no_caucasian": 0, "caucasian": 1},
)
...
TMAPS["mothers_age"] = TensorMap(
    ...
    normalization={"mean": 75.555, "std": 11.977},
    annotation_units=4,
)
...
TMAPS["fathers_age"] = TensorMap(
    ...
    normalization={"mean": 70.928, "std": 12.746},
    annotation_units=4,
)

TMAPS["genetic_sex"] = TensorMap(
    "Genetic-sex_Male_0_0",
    Interpretation.CATEGORICAL,
...
TMAPS["bmi"] = TensorMap(
    ...
    Interpretation.CONTINUOUS,
    path_prefix="continuous",
    channel_map={"23104_Body-mass-index-BMI_0_0": 0},
    annotation_units=1,
    validator=make_range_validator(0, 300),
...
TMAPS["birth_year"] = TensorMap(
    ...
    annotation_units=1,
    loss="logcosh",
    validator=make_range_validator(1901, 2025),
    normalization={"mean": 1952.0639129359386, "std": 7.656326148519739},
)
TMAPS["birth_year_34"] = TensorMap(
    "34_Year-of-birth_0_0",
    Interpretation.CONTINUOUS,
    path_prefix="continuous",
...
TMAPS["age_0"] = TensorMap(
    ...
    path_prefix="continuous",
    loss="logcosh",
    validator=make_range_validator(1, 120),
    normalization={"mean": 56.52847159208494, "std": 8.095287610193827},
    channel_map={"21003_Age-when-attended-assessment-centre_0_0": 0},
)
TMAPS["age_1"] = TensorMap(
    "21003_Age-when-attended-assessment-centre_1_0",
    Interpretation.CONTINUOUS,
    path_prefix="continuous",
    loss="logcosh",
    validator=make_range_validator(1, 120),
    normalization={"mean": 61.4476555588322, "std": 7.3992113757847005},
    channel_map={"21003_Age-when-attended-assessment-centre_1_0": 0},
)
...
TMAPS["brain_volume"] = TensorMap(
    ...
    Interpretation.CONTINUOUS,
    path_prefix="continuous",
    normalization={"mean": 1165940.0, "std": 111511.0},
    channel_map={"25010_Volume-of-brain-greywhite-matter_2_0": 0},
    loss="logcosh",
    loss_weight=0.1,
)

TMAPS["sodium"] = TensorMap(
    "30530_Sodium-in-urine_0_0",
    Interpretation.CONTINUOUS,
    path_prefix="continuous",
...
TMAPS["potassium"] = TensorMap(
    "30520_Potassium-in-urine_0_0",
    Interpretation.CONTINUOUS,
    path_prefix="continuous",
    channel_map={"30520_Potassium-in-urine_0_0": 0},
    normalization={"mean": 63.06182700345117, "std": 33.84208704773539},
    annotation_units=1,
    loss="logcosh",
)
TMAPS["cholesterol_hdl"] = TensorMap(
    "30760_HDL-cholesterol_0_0",
    Interpretation.CONTINUOUS,
    path_prefix="continuous",
...
TMAPS["cigarettes"] = TensorMap(
    "2887_Number-of-cigarettes-previously-smoked-daily_0_0",
    Interpretation.CONTINUOUS,
    path_prefix="continuous",
    channel_map={"2887_Number-of-cigarettes-previously-smoked-daily_0_0": 0},
    normalization={"mean": 18.92662147068755, "std": 10.590930376362259},
    annotation_units=1,
)
TMAPS["alcohol"] = TensorMap(
    "5364_Average-weekly-intake-of-other-alcoholic-drinks_0_0",
    Interpretation.CONTINUOUS,
    path_prefix="continuous",
    channel_map={"5364_Average-weekly-intake-of-other-alcoholic-drinks_0_0": 0},
    normalization={"mean": 0.03852570253005904, "std": 0.512608370266108},
    annotation_units=1,
)
...
TMAPS["alcohol_0"] = TensorMap(
    "alcohol_0",
    Interpretation.CATEGORICAL,
    path_prefix="categorical",
    channel_map=alcohol_channel_map(instance=0),
)
TMAPS["alcohol_1"] = TensorMap(
    "alcohol_1",
    Interpretation.CATEGORICAL,
    path_prefix="categorical",
    channel_map=alcohol_channel_map(instance=1),
)
TMAPS["alcohol_2"] = TensorMap(
    "alcohol_2",
    Interpretation.CATEGORICAL,
    path_prefix="categorical",
    channel_map=alcohol_channel_map(instance=2),
)
...
TMAPS["alcohol_status_0"] = TensorMap(
    "alcohol_status_0",
    Interpretation.CATEGORICAL,
    path_prefix="categorical",
    channel_map=alcohol_status_map(instance=0),
)
TMAPS["alcohol_status_1"] = TensorMap(
    "alcohol_status_1",
    Interpretation.CATEGORICAL,
    path_prefix="categorical",
    channel_map=alcohol_status_map(instance=1),
)
TMAPS["alcohol_status_2"] = TensorMap(
    "alcohol_status_2",
    Interpretation.CATEGORICAL,
    path_prefix="categorical",
    channel_map=alcohol_status_map(instance=2),
)
...
TMAPS["alcohol_meals_0"] = TensorMap(
    "alcohol_meals_0",
    Interpretation.CATEGORICAL,
    path_prefix="categorical",
    channel_map=alcohol_meals_map(instance=0),
)
TMAPS["alcohol_meals_1"] = TensorMap(
    "alcohol_meals_1",
    Interpretation.CATEGORICAL,
    path_prefix="categorical",
    channel_map=alcohol_meals_map(instance=1),
)
TMAPS["alcohol_meals_2"] = TensorMap(
    "alcohol_meals_2",
    Interpretation.CATEGORICAL,
    path_prefix="categorical",
    channel_map=alcohol_meals_map(instance=2),
)

TMAPS["coffee"] = TensorMap(
    "1498_Coffee-intake_0_0",
    Interpretation.CONTINUOUS,
    path_prefix="continuous",
    channel_map={"1498_Coffee-intake_0_0": 0},
    normalization={"mean": 2.015086529948216, "std": 2.0914960998390497},
    annotation_units=1,
)
TMAPS["water"] = TensorMap(
    "1528_Water-intake_0_0",
    Interpretation.CONTINUOUS,
    path_prefix="continuous",
    channel_map={"1528_Water-intake_0_0": 0},
    normalization={"mean": 2.7322977785723324, "std": 2.261996814128837},
    annotation_units=1,
)
TMAPS["meat"] = TensorMap(
    "3680_Age-when-last-ate-meat_0_0",
    Interpretation.CONTINUOUS,
    path_prefix="continuous",
    channel_map={"3680_Age-when-last-ate-meat_0_0": 0},
    normalization={"mean": 29.74062983480561, "std": 14.417292213873964},
    annotation_units=1,
)
TMAPS["walks"] = TensorMap(
    ...
    normalization={"mean": 5.369732285440756, "std": 1.9564911925721618},
    annotation_units=1,
)
TMAPS["walk_duration"] = TensorMap(
    "874_Duration-of-walks_0_0",
    Interpretation.CONTINUOUS,
    path_prefix="continuous",
    channel_map={"874_Duration-of-walks_0_0": 0},
    normalization={"mean": 61.64092215093373, "std": 78.79522990818906},
    annotation_units=1,
)
TMAPS["physical_activities"] = TensorMap(
    ...
    path_prefix="continuous",
    channel_map={
        "884_Number-of-daysweek-of-moderate-physical-activity-10-minutes_0_0": 0,
    },
    normalization={"mean": 3.6258833281089258, "std": 2.3343738999823676},
    annotation_units=1,
)
TMAPS["physical_activity"] = TensorMap(
    ...
    normalization={"mean": 66.2862593866103, "std": 77.28681218835422},
    annotation_units=1,
)
TMAPS["physical_activity_vigorous"] = TensorMap(
    "904_Number-of-daysweek-of-vigorous-physical-activity-10-minutes_0_0",
    Interpretation.CONTINUOUS,
    channel_map={
        "904_Number-of-daysweek-of-vigorous-physical-activity-10-minutes_0_0": 0,
    },
    path_prefix="continuous",
    normalization={"mean": 1.838718301735063, "std": 1.9593505421480895},
    annotation_units=1,
)
TMAPS["physical_activity_vigorous_duration"] = TensorMap(
    ...
    normalization={"mean": 44.854488382965144, "std": 48.159967071781466},
    annotation_units=1,
)
TMAPS["tv"] = TensorMap(
    ...
    normalization={"mean": 2.7753595642790914, "std": 1.7135478462887321},
    annotation_units=1,
)
TMAPS["computer"] = TensorMap(
    "1080_Time-spent-using-computer_0_0",
    Interpretation.CONTINUOUS,
    path_prefix="continuous",
    channel_map={"1080_Time-spent-using-computer_0_0": 0},
    normalization={"mean": 0.9781465855433753, "std": 1.4444414103121512},
    annotation_units=1,
)
TMAPS["car"] = TensorMap(
    "1090_Time-spent-driving_0_0",
    Interpretation.CONTINUOUS,
    path_prefix="continuous",
    channel_map={"1090_Time-spent-driving_0_0": 0},
    normalization={"mean": 0.8219851505445748, "std": 1.304094814200189},
    annotation_units=1,
)
TMAPS["summer"] = TensorMap(
    ...
    normalization={"mean": 3.774492304870845, "std": 2.430483731404539},
    annotation_units=1,
)
...
TMAPS["systolic_blood_pressure_1"] = TensorMap(
    "4080_Systolic-blood-pressure-automated-reading_1_0",
    Interpretation.CONTINUOUS,
    path_prefix="continuous",
    loss="logcosh",
...
TMAPS["diastolic_blood_pressure_1"] = TensorMap(
    "4079_Diastolic-blood-pressure-automated-reading_1_0",
    Interpretation.CONTINUOUS,
    path_prefix="continuous",
    loss="logcosh",
...
TMAPS["systolic_blood_pressure_2"] = TensorMap(
    "4080_Systolic-blood-pressure-automated-reading_2_0",
    Interpretation.CONTINUOUS,
    path_prefix="continuous",
    loss="logcosh",
...
TMAPS["diastolic_blood_pressure_2"] = TensorMap(
    "4079_Diastolic-blood-pressure-automated-reading_2_0",
    Interpretation.CONTINUOUS,
    path_prefix="continuous",
    loss="logcosh",
...
TMAPS["categorical-phenotypes-134"] = TensorMap(
    ...
    channel_map={
        ...
        "Alcohol-usually-taken-with-meals_Yes_2_0": 5,
        "Beef-intake_Less-than-once-a-week_0_0": 6,
        ...
        "Breastfed-as-a-baby_Yes_0_0": 12,
        "Breathing-problems-during-period-of-job_No_0_0": 13,
        "Breathing-problems-during-period-of-job_No_0_1": 14,
        "Cereal-type_Oat-cereal-eg-Ready-Brek-porridge_0_0": 17,
        "Cheese-intake_24-times-a-week_0_0": 18,
        "Cheese-intake_24-times-a-week_2_0": 19,
        "Coffee-type_Instant-coffee_0_0": 20,
        "Comparative-body-size-at-age-10_Thinner_0_0": 21,
        "Comparative-height-size-at-age-10_About-average_0_0": 22,
        "Country-of-birth-UKelsewhere_England_0_0": 23,
        "Country-of-birth-UKelsewhere_England_2_0": 24,
        ...
        "Ever-had-cervical-smear-test_Yes_0_0": 34,
        "Ever-had-cervical-smear-test_Yes_2_0": 35,
        ...
        "Eye-problemsdisorders_None-of-the-above_2_0": 40,
        "FI1-numeric-addition-test_15_2_0": 41,
        "FI3-word-interpolation_Adult_2_0": 42,
        "FI4-positional-arithmetic_6_2_0": 43,
        "FI6-conditional-arithmetic_69_2_0": 44,
        "FI7-synonym_Cease_2_0": 45,
        "Facial-ageing_Younger-than-you-are_0_0": 46,
        "Facial-ageing_Younger-than-you-are_2_0": 47,
        "Father-still-alive_No_0_0": 48,
        "Father-still-alive_No_2_0": 49,
        "Father-still-alive_Yes_0_0": 50,
        "Fracturedbroken-bones-in-last-5-years_No_0_0": 51,
        "Fracturedbroken-bones-in-last-5-years_No_2_0": 52,
        "Genetic-sex_Female_0_0": 53,
        "Had-menopause_Yes_2_0": 54,
        "Hair-colour-natural-before-greying_Dark-brown_0_0": 55,
        "Handedness-chiralitylaterality_Righthanded_0_0": 56,
        "Handedness-chiralitylaterality_Righthanded_2_0": 57,
        "Hearing-difficultyproblems_No_0_0": 58,
        "Hearing-difficultyproblems_No_2_0": 59,
        "Hot-drink-temperature_Hot_0_0": 60,
        "Hot-drink-temperature_Hot_2_0": 61,
        "Lambmutton-intake_Less-than-once-a-week_0_0": 62,
        ...
        "Mouthteeth-dental-problems_None-of-the-above_2_0": 81,
        "Noisy-workplace_No_2_0": 82,
        "Nonoily-fish-intake_Once-a-week_0_0": 83,
        "Nonoily-fish-intake_Once-a-week_2_0": 84,
        ...
        "Part-of-a-multiple-birth_No_0_0": 93,
        "Part-of-a-multiple-birth_No_2_0": 94,
        "Past-tobacco-smoking_I-have-never-smoked_0_0": 95,
        "Past-tobacco-smoking_I-have-never-smoked_2_0": 96,
        "Pork-intake_Less-than-once-a-week_0_0": 97,
        "Pork-intake_Less-than-once-a-week_2_0": 98,
        "Poultry-intake_24-times-a-week_0_0": 99,
        "Poultry-intake_24-times-a-week_2_0": 100,
        "Processed-meat-intake_Less-than-once-a-week_2_0": 101,
        "Salt-added-to-food_Neverrarely_0_0": 102,
        "Salt-added-to-food_Neverrarely_2_0": 103,
        "Shortness-of-breath-walking-on-level-ground_No_2_0": 104,
        "Skin-colour_Fair_0_0": 105,
        "Smoking-status_Never_0_0": 106,
        "Smoking-status_Never_2_0": 107,
        "Smokingsmokers-in-household_No_0_0": 108,
        "Smokingsmokers-in-household_No_2_0": 109,
        ...
        "UK-Biobank-assessment-centre_Cheadle-imaging_2_0": 120,
        "Usual-walking-pace_Brisk-pace_0_0": 121,
        "Usual-walking-pace_Brisk-pace_2_0": 122,
        "Usual-walking-pace_Steady-average-pace_0_0": 123,
        "Usual-walking-pace_Steady-average-pace_2_0": 124,
        "Variation-in-diet_Sometimes_0_0": 125,
        ...
        "Wears-glasses-or-contact-lenses_Yes_0_0": 131,
        "Wears-glasses-or-contact-lenses_Yes_2_0": 132,
        ...
        "Worked-with-pesticides_Rarelynever_0_0": 70,
        "Worked-with-pesticides_Rarelynever_0_1": 71,
        ...
        "Workplace-very-dusty_Rarelynever_0_0": 127,
        "Workplace-very-dusty_Rarelynever_0_1": 128,
    },
)
