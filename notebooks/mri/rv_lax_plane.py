...
from parameterize_segmentation import intersection_over_union, align_datasets, hd5_to_polydatas
import scipy
...
for i, hd5 in enumerate(sorted(hd5s)):
    ...
    hd5 = f'/mnt/disks/segmented-sax-v20201124-lax-v20201122/2020-11-24/2865182.hd5'
    ...
    try:
      ...
      # except:
      #     pass
        polydatas = hd5_to_polydatas(f'/home/pdiachil/projects/chambers/poisson_sax_v20201124_lax_v20201122_RV_{sample_id}.hd5')
        planes = clip_by_separation_plane(annot_datasets[0], annot_datasets[1:], 
                                          [MRI_LAX_4CH_SEGMENTED_CHANNEL_MAP['RV_cavity'], 
                                           MRI_LAX_4CH_SEGMENTED_CHANNEL_MAP['RA_cavity']],
                                          polydatas)

    except FutureWarning as e:
        logging.info(f'Caught exception {e} at {sample_id}')
