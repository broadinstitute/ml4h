...
# MRI_SAX_SEGMENTED_CHANNEL_MAP = {'RV_cavity': 5, 'LV_cavity': 4, 'LV_free_\wall': 3, 'interventricular_septum': 2}
...
channels = [
    ...
    [
        [MRI_LAX_4CH_SEGMENTED_CHANNEL_MAP['LV_cavity'], MRI_LAX_4CH_SEGMENTED_CHANNEL_MAP['interventricular_septum'], MRI_LAX_4CH_SEGMENTED_CHANNEL_MAP['LV_anterolateral_wall']]
    ]
]

channels[0] += [MRI_SAX_SEGMENTED_CHANNEL_MAP['LV_cavity'] for d in range(1, 13)]
channels[1] += [[MRI_SAX_SEGMENTED_CHANNEL_MAP['LV_cavity'], MRI_SAX_SEGMENTED_CHANNEL_MAP['interventricular_septum'], MRI_SAX_SEGMENTED_CHANNEL_MAP['LV_free_wall']] for d in range(1, 13)]
# channels = [[MRI_SAX_SEGMENTED_CHANNEL_MAP['RV_cavity'] for d in range(1, 10)]]

chambers = ['SAXLV', 'SAXLVW']
# %%
    ...
    try:
      ...
      #     pass
        ...
        dx = align_datasets(
            ...
            [MRI_SAX_SEGMENTED_CHANNEL_MAP[key] for key in ['LV_cavity']],
            [MRI_LAX_4CH_SEGMENTED_CHANNEL_MAP[key] for key in ['LV_cavity']],
            t=0,
        )
