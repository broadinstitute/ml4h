...
phenotypes = pd.read_csv('/home/pdiachil/ml/notebooks/ppg/ppgs_covariates.csv')
...
f, ax = plt.subplots()
sns.distplot(phenotypes['pc_ae_1'])
# %%
...
plot_or_hr(odds_ratio_univariable, label_dic, disease_list, f'or_univariate_ppg')
...
plot_or_hr(hazard_ratio_univariable, label_dic, disease_list, f'hr_univariate_ppg', occ='incident')
...
plot_or_hr(odds_ratio_multivariable, labels, disease_list, f'or_multivariate_ppg_pulse_nopcs', occ='prevalent', horizontal_line_y=0)

hazard_ratio_multivariable = hazard_ratios(
    phenotypes, diseases_unpack, labels,
    disease_list, covariates=covariates, instance=0, dont_scale=dont_scale,
)
plot_or_hr(hazard_ratio_multivariable, labels, disease_list, f'hr_multivariate_ppg_pulse_nopcs', occ='incident', horizontal_line_y=0)
