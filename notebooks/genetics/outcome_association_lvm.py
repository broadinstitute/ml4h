...
phenotypes = pd.read_csv('/home/pdiachil/ml/notebooks/genetics/lvm_all_shaan_poisson_all_covariates.csv')
...
label_dic = {
    'LVM': ['LVM (petersen)', 'g'],
    'LVM_Poisson': ['LVM (poisson)', 'g'],
    'adjusted_myocardium_mass_asym_outlier_no_poor_actual': ['LVM (inlinevf)', 'g'],
    'adjusted_myocardium_mass_asym_outlier_no_poor_prediction': ['LVM (ECG)', 'g'],
    'age': ['Age', 'yrs'],
    'male': ['Male', ''],
    # 'nonwhite': ['Nonwhite', ''],
    'bmi': ['BMI', 'units'],
...
f, ax = plt.subplots()
sns.distplot(phenotypes['LVM_Poisson'])
# %%
...
disease_list = [
    ...
    ['Aortic_valve_disease', 'aortic valve disease'],
    ['Mitral_valve_disease', 'mitral valve disease'],
...
# Multivariate
covariates = ['age', 'male']
phenotypes = phenotypes.dropna(subset=covariates)

phenotype_subset = [
    'LVM_Poisson',
    'adjusted_myocardium_mass_asym_outlier_no_poor_actual',
    #'adjusted_myocardium_mass_asym_outlier_no_poor_prediction',
]
...
plot_or_hr(odds_ratio_multivariable, labels, disease_list, f'or_multivariate_all_lvm', occ='prevalent', horizontal_line_y=3.5)

hazard_ratio_multivariable = hazard_ratios(
    phenotypes, diseases_unpack, labels,
    disease_list, covariates=covariates, instance=2, dont_scale=dont_scale,
)
plot_or_hr(hazard_ratio_multivariable, labels, disease_list, f'hr_multivariate_all_lvm', occ='incident', horizontal_line_y=3.5)
