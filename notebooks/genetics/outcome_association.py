...
# %%bigquery pulse_rate
# select sample_id, FieldID, instance, value from `ukbb7089_202006.phenotype`
# where FieldID = 4194 -- pulse rate

# # %%
# pulse_rate.to_csv('bq_pulse_rate.tsv', sep='\t')
...
for i, la_volume_set in enumerate(la_volume_sets):
    ...
    for pheno in pheno_dic:
        instance = 0 if pheno in dont_update else 0
        if pheno == 54:
...
# %%
la_volumes_petersen.to_csv('/home/pdiachil/ml/notebooks/ppg/ppgs_covariates.csv', index=False)
